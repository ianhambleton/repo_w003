...
** ---
** COL 2: Deaths 2019 (women N)
** COL 3: Deaths 2019 (men N)
** COL 4: Deaths 2019 (both N)
** ---
** COL 5: DALYs 2019 (women N)
** COL 6: DALYs 2019 (men N)
** COL 7: DALYs 2019 (both N)
** ---
** COL 8: Mortality rate change (2000-2019) (women N)
** COL 9: Mortality rate change (2000-2019) (men N)
** COL 10: DALY rate change (2000-2019) (women N)
** COL 11: Daly rate change (2000-2019) (women N)
** ------------------------------------------------------------




Present for each subregion of the Americas. Americas total. World total.
...
tempfile create_table
save `create_table', replace
...
use `create_table', clear
        ...
        ** Save Word table
        putdocx save "`outputpath'/articles/paper-inj/article-draft/inj_table1", replace 
