** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-001-subregion-panel.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-001-subregion-panel", replace
** HEADER -----------------------------------------------------
...
**  610     Cancers                                     -----> 4 
**  800     Diabetes                                        -----> 6
**  820     Mental Health and Substance Abuse   -----> 7
**  940     Neurological Conditions             -----> 7
**  1100    CVD                                     -----> 3
**  1170    CRD                                         -----> 5
**  1510    Injuries / External Causes                      -----> 8
** ------------------------------------------
...
** Variable labelling
label var who_region "WHO region of the Americas"
...
* subregions
#delimit ; 
label define region_    2000 "americas", modify;                     
#delimit cr 
...
gen sex = 3 
label data "Crude and Adjusted mortality rates: PAHO sub-regions"
save "`datapath'\from-who\chap2_initial_panel_both", replace
