...
** save "`datapath'\from-who\paper1-chap3_byage_groups_malefemale", replace
   save "`datapath'\from-who\deaths1", replace
...
** save "`datapath'\from-who\paper1-chap2_000a_mr_region-groups", replace
   save "`datapath'\from-who\mortalityrate1", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_groups_both", replace
   save "`datapath'\from-who\deaths2", replace
...
** save "`datapath'\from-who\paper1-chap2_000a_mr_region_groups_both", replace
   save "`datapath'\from-who\mortalityrate2", replace
...
use "`datapath'\from-who\mortalityrate2" , clear
append using "`datapath'\from-who\mortalityrate1"
...
save "`datapath'\from-who\mortalityrate_12", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale", replace
   save "`datapath'\from-who\deaths3", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_both", replace
   save "`datapath'\from-who\deaths4", replace
