...
save "`datapath'\from-who\decomposition_deaths_women", replace
...
** Save the decomposition dataset, then will be used for sensitivity analyses
save "`datapath'\from-who\decomposition_daly_women", replace

use "`datapath'\from-who\decomposition_deaths_women", replace
append using "`datapath'\from-who\decomposition_daly_women"

** FINAL decomp dataset
save "`datapath'\from-who\decomposition_women", replace
