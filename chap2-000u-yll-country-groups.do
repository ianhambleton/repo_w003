...
preserve
    ...
    save "`datapath'\from-who\chap2_000g_yll_country_haiti_natural_disaster_groups", replace
restore
...
save "`datapath'\from-who\chap2_000g_yll_country_groups", replace
...
preserve
    keep if iso3n==332 & year==2010 & ghecause==54
    save "`datapath'\from-who\chap2_000g_yll_country_haiti_natural_disaster", replace
restore
...
** replace pop = pop/1000000
label data "Crude and Adjusted ylls: PAHO sub-regions"
save "`datapath'\from-who\chap2_000g_yll_country_groups_both", replace
