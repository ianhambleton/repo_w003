...
**  DO-FILE METADATA
    ...
    //  algorithm task			    Reading the WHO GHE dataset - Life Tables - Global
...
** ************************************************************
insheet using "`datapath'\from-who\lifetables\lifetable-2019-global.csv", clear comma names
...
drop numeric low high stderr stddev comments wbregion
...
save "`datapath'\from-who\lifetables\who-lifetable-2019-global", replace
