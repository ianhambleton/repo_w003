...
#delimit ;
	gr twoway 
		...
		/// 42. Brazil
		/// 43. Mexico
		(line dalyr1 yr1 			if region==36 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==36 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==36 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==36 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==37 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==37 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==37 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==37 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==38 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==38 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==38 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==38 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==39 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==39 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==39 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==39 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==40 & year<2010, lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==40 & year<2010, lw(0.3) lc("`al_line'") lp("-"))
		(line dalyr1 yr1 			if region==40 & year>2010, lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==40 & year>2010, lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==40 & year<2010, lw(none) color("`al_fill'%50"))
	    (rarea dalyr1 dalyr2 yr1 	if region==40 & year>2010, lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==40 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==41 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==41 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==41 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==41 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==42 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==42 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==42 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==42 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==43 , lw(0.3) lc("`al_line'") lp("l"))
		(line dalyr2 yr1			if region==43 , lw(0.3) lc("`al_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==43 , lw(none) color("`al_fill'%50"))
		(line  dam3 yr1		 		if region==43 , lw(0.3) lc("gs0") lp("-"))
       ...
       (function y=11500, range(2000 2183) lc(gs12) dropline(2022 2045 2068 2091 2114 2137 2160 2183))
		...
		,
            ...
            text(7000 2101.25 "{&lowast}",  place(e) size(6) color("gs0"))	
...
#delimit ;
	gr twoway 
		...
		/// 700. Brazil
		/// 800. Mexico
		(line dalyr1 yr1 			if region==36 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==36 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==36 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==36 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==37 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==37 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==37 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==37 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==38 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==38 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==38 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==38 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==39 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==39 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==39 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==39 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==40 & year<2010, lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==40 & year<2010, lw(0.3) lc("`un_line'") lp("-"))
		(line dalyr1 yr1 			if region==40 & year>2010, lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==40 & year>2010, lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==40 & year<2010, lw(none) color("`un_fill'%50"))
	    (rarea dalyr1 dalyr2 yr1 	if region==40 & year>2010, lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==40 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==41 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==41 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==41 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==41 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==42 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==42 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==42 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==42 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==43 , lw(0.3) lc("`un_line'") lp("l"))
		(line dalyr2 yr1			if region==43 , lw(0.3) lc("`un_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==43 , lw(none) color("`un_fill'%50"))
		(line  dam3 yr1		 		if region==43 , lw(0.3) lc("gs0") lp("-"))
       ...
       (function y=11500, range(2000 2183) lc(gs12) dropline(2022 2045 2068 2091 2114 2137 2160 2183))
		...
		,
	        ...
	        /// STAR for Latin Caribbean
            text(4600 2101.25 "{&lowast}",  place(e) size(6) color("gs0"))	
...
#delimit ;
	gr twoway 
		...
		/// 700. Brazil
		/// 800. Mexico
		(line dalyr1 yr1 			if region==36 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==36 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==36 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==36 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==37 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==37 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==37 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==37 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==38 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==38 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==38 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==38 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==39 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==39 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==39 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==39 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==40 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==40 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==40 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==40 , lw(0.3) lc("gs0") lp("-"))
		
		/// (line  dam3 yr1		 		if region==40 , lw(0.3) lc("gs0") lp("-"))
		/// (line dalyr1 yr1 			if region==40 & year<2010, lw(0.3) lc("`in_line'") lp("l"))
		/// (line dalyr2 yr1			if region==40 & year<2010, lw(0.3) lc("`in_line'") lp("-"))
		/// (line dalyr1 yr1 			if region==40 & year>2010, lw(0.3) lc("`in_line'") lp("l"))
		/// (line dalyr2 yr1			if region==40 & year>2010, lw(0.3) lc("`in_line'") lp("-"))
	    /// (rarea dalyr1 dalyr2 yr1 	if region==40 & year<2010, lw(none) color("`in_fill'%50"))
	    /// (rarea dalyr1 dalyr2 yr1 	if region==54000 & year>2010, lw(none) color("`in_fill'%50"))

		(line dalyr1 yr1 			if region==41 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==41 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==41 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==41 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==42 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==42 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==42 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==42 , lw(0.3) lc("gs0") lp("-"))

		(line dalyr1 yr1 			if region==43 , lw(0.3) lc("`in_line'") lp("l"))
		(line dalyr2 yr1			if region==43 , lw(0.3) lc("`in_line'") lp("-"))
	    (rarea dalyr1 dalyr2 yr1 	if region==43 , lw(none) color("`in_fill'%50"))
		(line  dam3 yr1		 		if region==43 , lw(0.3) lc("gs0") lp("-"))
