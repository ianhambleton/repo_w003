...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths.png", replace width(4000)
...
** FIGURE
    ...
    putpdf text ("`dagger' "), bold
    putpdf text ("The percentage change in deaths between 2000 and 2019."), linebreak
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         28 "St.Vincent & Gren"
                            12 "Antigua & Barbuda"
                            33 "Trinidad & Tobago"
                            1  "Dominican Rep", modify;
    label values y y; 
...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths_lo.png", replace width(4000)
...
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3a_lo", replace
...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths_hi.png", replace width(4000)
...
** FIGURE
    ...
    putpdf text ("`dagger' "), bold
    putpdf text ("The percentage change in DALYs between 2000 and 2019."), linebreak
...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3b_daly_lo.png", replace width(4000)
...
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3b_lo", replace
...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3b_daly_hi.png", replace width(4000)
...
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3b_hi", replace
...
replace cname = "LAC" if cname ==""
	...
	** Begin Table 
	...
	putdocx paragraph 
		putdocx text ("TABLE S9. "), bold
		putdocx text ("Deaths in 2000 and in 2019, and percentage change in deaths between 2000 and 2019, with associated 95% Uncertainty Intervals. Women and Men combined."), 
		** Place data 
		...
		** Column and Row headers
		...
		putdocx save "`outputpath'/decomp_ci", replace 
