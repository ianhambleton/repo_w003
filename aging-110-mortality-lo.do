...
**!  ------------------------------------------------------------
**!  PART 1
**!  REGION-LEVEL MORTALITY DATA PREPARATION
**!  SEX-SPECIFIC
**!  ------------------------------------------------------------
...
** ------------------------------------------
** Loading DEATHS datasets for WHO region: Americas 
** ------------------------------------------
...
preserve
    ...
    rename pop t1
    collapse (sum) dths (mean) pop=t1 , by(year sex who_region age18 agroup subgroup)
    keep if subgroup == 1
    gen ghecause = 50
    drop subgroup
...
** save "`datapath'\from-who\paper1-chap3_byage_groups_malefemale", replace
   rename dths dths_lo
   save "`datapath'\from-who\deaths1_lo", replace
...
** save "`datapath'\from-who\paper1-chap2_000a_mr_region-groups", replace
   rename cases cases_lo 
   rename crate crate_lo 
   rename arate arate_lo
   drop aupp alow 
   save "`datapath'\from-who\mortalityrate1_lo", replace
...
preserve
    ...
    replace subgroup = 1 if ghecause>=400 & ghecause<=900
    rename pop t1
    collapse (sum) dths (mean) pop=t1 , by(year who_region age18 agroup subgroup)
    keep if subgroup == 1
    gen ghecause = 50
    drop subgroup
    save `combined' , replace
...
** USED IN FIGURE 3 (and associated)
** save "`datapath'\from-who\paper1-chap3_byage_groups_both", replace
   rename dths dths_lo
   save "`datapath'\from-who\deaths2_lo", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted mortality rates: WHO regions"
** save "`datapath'\from-who\paper1-chap2_000a_mr_region_groups_both", replace
   rename cases cases_lo 
   rename crate crate_lo 
   rename arate arate_lo
   drop aupp alow 
   save "`datapath'\from-who\mortalityrate2_lo", replace



** Join
** use "`datapath'\from-who\paper1-chap2_000a_mr_region_groups_both" , clear
** append using "`datapath'\from-who\paper1-chap2_000a_mr_region-groups"
use "`datapath'\from-who\mortalityrate2_lo" , clear
append using "`datapath'\from-who\mortalityrate1_lo"
...
save "`datapath'\from-who\mortalityrate_12_lo", replace
...
**!  ------------------------------------------------------------
**!  PART 3
**!  COUNTRY-LEVEL MORTALITY DATA PREPARATION
**!  SEX-SPECIFIC
**!  ------------------------------------------------------------
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale", replace
   rename dths dths_lo
   save "`datapath'\from-who\deaths3_lo", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_both", replace
   rename dths dths_lo
   save "`datapath'\from-who\deaths4_lo", replace
