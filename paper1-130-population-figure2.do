...
** Y-axis Labelling
local yax1 " 1 "Haiti" 2 "Guatemala" 3 "Bolivia" 4 "Guyana" 5 "Belize" 6 "Suriname" " 
local yax2 " 8 "Paraguay" 9 "Honduras" 10 "Venezuela" 11 "Bahamas" 12 "Nicaragua" 13 "Dominican Rep" 14 "Grenada" " 
local yax3 " 16 "El Salvador" 17 "Mexico" 18 "Ecuador" 19 "Argentina" 20 "St Vincent & Gren" 21 "Panama" 22 "Jamaica" " 
local yax4 " 24 "Antigua & Barbuda" 25 "Peru" 26 "THE AMERICAS" 27 "Uruguay" 28 "United States" 29 "Colombia" 30 "Trinidad & Tobago" " 
local yax5 " 32 "Canada" 33 "Brazil" 34 "St Lucia" 35 "Costa Rica" 36 "Chile" 37 "Barbados" 38 "Cuba" " 
...
#delimit ;
	gr twoway 
        ...
        (sc uid1 dratio1980 if uid1!=26 , msize(4) m(o) mlc(gs10) mfc("`dr1980'") mlw(0.1))
        (sc uid1 dratio2020 if uid1!=26 , msize(4) m(o) mlc(gs10) mfc("`dr2020'") mlw(0.1))
        (sc uid1 dratio2060 if uid1!=26 , msize(4) m(o) mlc(gs10) mfc("`dr2060'") mlw(0.1))

		/// Dependency Ratio Points - The Americas
        (sc uid1 dratio1980 if uid1==26 , msize(4) m(o) mlc(gs10) mfc("`am1980'") mlw(0.1))
        (sc uid1 dratio2020 if uid1==26 , msize(4) m(o) mlc(gs10) mfc("`am2020'") mlw(0.1))
        (sc uid1 dratio2060 if uid1==26 , msize(4) m(o) mlc(gs10) mfc("`am2060'") mlw(0.1))
		,
            ...
            text( 40 55 "2060"      ,  place(c) size(3.5) color(gs8) just(right))
            text( 1 55 "${dr_1_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 2 55 "${dr_2_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 3 55 "${dr_3_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 4 55 "${dr_4_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 5 55 "${dr_5_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 6 55 "${dr_6_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 8 55 "${dr_8_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text( 9 55 "${dr_9_2060}"  ,  place(c) size(3) color(gs4) just(right))
            text(10 55 "${dr_10_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(11 55 "${dr_11_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(12 55 "${dr_12_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(13 55 "${dr_13_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(14 55 "${dr_14_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(16 55 "${dr_16_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(17 55 "${dr_17_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(18 55 "${dr_18_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(19 55 "${dr_19_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(20 55 "${dr_20_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(21 55 "${dr_21_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(22 55 "${dr_22_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(24 55 "${dr_24_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(25 55 "${dr_25_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(26 55 "${dr_26_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(27 55 "${dr_27_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(28 55 "${dr_28_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(29 55 "${dr_29_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(30 55 "${dr_30_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(32 55 "${dr_32_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(33 55 "${dr_33_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(34 55 "${dr_34_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(35 55 "${dr_35_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(36 55 "${dr_36_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(37 55 "${dr_37_2060}" ,  place(c) size(3) color(gs4) just(right))
            text(38 55 "${dr_38_2060}" ,  place(c) size(3) color(gs4) just(right))
