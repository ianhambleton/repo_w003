...
**  DO-FILE METADATA
    ...
    //  algorithm task			    Reading the WHO GHE dataset - disease burden, YLL and yld
...
** TABLE 3
** ylds due to Combined NCDs
local a = 4
** forval a = 1(1)33 {

        use "C:\Sync\CaribData\My Drive\output\analyse-write\w003\data\from-who\chap2_000_yld_adjusted", clear
        ...
        ** Extract the required yld metrics
        forval x = 1(1)3 {
            forval b = 1(1)3 {
...
** forval a = 1(1)33 {
    ...
    use "`outputpath'/country_report_table4-yld", clear
...
** Save the PDF
    ...
    putpdf save "`outputpath'/briefing-`crep'-ylds", replace
