** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    phd-mr-country-age-stratified.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\phd-mr-country-age-stratified", replace
** HEADER ----------------------------------------------------- 
...
drop ase iso3n 
label data "Crude and Adjusted mortality rates: age-stratified"
tempfile file_mf 
...
** Metadata
label data "Restricted GHE DEATHS dataset (2000-2019): created 11-Jun-2024"
