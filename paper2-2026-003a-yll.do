** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2026-003-yll.do
    //  project:				    WHO Global Health Estimates 2021
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	16-JUN-2025
    //  algorithm task			    Reading the WHO GHE 2021 dataset: YLL data
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2026-003a-yll", replace
** HEADER -----------------------------------------------------

    
** ************************************************************
** LOAD and prepare GHE 2021 YLL data
** ************************************************************
** import delimited using "`datapath'\AMR-GHE-2021\AMR_GHE_2021_YLLs.csv", clear rowrange(1:1000000)
import delimited using "`datapath'\AMR-GHE-2021\AMR_GHE_2021_YLLs.csv", clear 
...
label data "WHO GHE 2024: YLLs, 2000-2021, individual countries"
tempfile ghe01 
save `ghe01', replace
...
** JOIN FINAL YLLs DATASET with ADDITIONAL REGIONS INFORMATION 
use `ghe01', clear 
...
label data "WHO GHE 2021: YLLs, 2000-2021, individual countries, extra region information"
save "`datapath'\ghe-2021-yll-001", replace
