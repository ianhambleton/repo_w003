** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2025-supplement-s5-drowning.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2025-supplement-s5-drowning", replace
** HEADER -----------------------------------------------------
...
** ------------------------------------------------------
    ...
    ** COLS 11/13. Change 2000-2021 (DALY rate)
        ...
        ** Save Word table
        putdocx save "`outputpath'/inj_table_s5-drowning", replace 
