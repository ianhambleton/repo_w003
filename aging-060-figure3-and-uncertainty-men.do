...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths_men.png", replace width(4000)
...
** FIGURE
    ...
    putpdf table t2(1,1)=image("`outputpath'/figure3a_deaths_men.png")
    putpdf paragraph ,  font("Calibri Light", 10)
...
** Save the PDF
    ...
    putpdf save "`outputpath'/figure3a_men", replace
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         24 "St.Vincent & Gren"
                            16 "Antigua & Barbuda"
                            33 "Trinidad & Tobago"
                            2  "Dominican Rep", modify;
    label values y y; 
    #delimit cr
...
** CHART
	...
	graph twoway 
		...
		name(deaths_est_men_lo)
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths_men_lo.png", replace width(4000)
...
** FIGURE
    ...
    putpdf table t2 = (1,1), width(90%) halign(center) border(all,nil) 
    putpdf table t2(1,1)=image("`outputpath'/figure3a_deaths_men_lo.png")
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text ("Data from: "), bold font("Calibri Light", 10)
    putpdf text ("UN DESA, Population Division (2019). World Population Prospects (Ref. 16), and from WHO Global Health Estimates (2019). (Refs. 19-21)"), font("Calibri Light", 10)
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3a_men_lo", replace
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         29 "St.Vincent & Gren"
                            22 "Antigua & Barbuda"
                            30 "Trinidad & Tobago"
                            1  "Dominican Rep", modify;
    label values y y; 
...
** CHART
	...
	graph twoway 
		...
		name(deaths_est_men_hi)
	;
#delimit cr
graph export "`outputpath'/figure3a_deaths_men_hi.png", replace width(4000)
...
** FIGURE
    ...
    putpdf table t2 = (1,1), width(90%) halign(center) border(all,nil) 
    putpdf table t2(1,1)=image("`outputpath'/figure3a_deaths_men_hi.png")
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text ("Data from: "), bold font("Calibri Light", 10)
    putpdf text ("UN DESA, Population Division (2019). World Population Prospects (Ref. 16), and from WHO Global Health Estimates (2019). (Refs. 19-21)"), font("Calibri Light", 10)
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3a_men_hi", replace
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         19 "St.Vincent & Gren"
                            15 "Antigua & Barbuda"
                            31 "Trinidad & Tobago"
                            1  "Dominican Rep", modify;
    label values y y; 
...
** CHART
	...
	;
#delimit cr
graph export "`outputpath'/figure3b_daly_men.png", replace width(4000)
...
** FIGURE
    ...
    putpdf text ("Figure 3a"), bold font("Calibri Light", 12)
    putpdf table t2 = (1,1), width(90%) halign(center) border(all,nil) 
    putpdf table t2(1,1)=image("`outputpath'/figure3b_daly_men.png")
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text ("Data from: "), bold font("Calibri Light", 10)
    putpdf text ("UN DESA, Population Division (2019). World Population Prospects (Ref. 16), and from WHO Global Health Estimates (2019). (Refs. 19-21)"), font("Calibri Light", 10)
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3b_men", replace
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         14 "St.Vincent & Gren"
                            13 "Antigua & Barbuda"
                            33 "Trinidad & Tobago"
                            3  "Dominican Rep", modify;
    label values y y; 
    #delimit cr
...
** CHART
	...
	graph twoway 
		...
		name(daly_est_men_lo)
	;
#delimit cr
graph export "`outputpath'/figure3b_daly_men_lo.png", replace width(4000)
...
** FIGURE
    ...
    putpdf table t2 = (1,1), width(90%) halign(center) border(all,nil) 
    putpdf table t2(1,1)=image("`outputpath'/figure3b_daly_men_lo.png")
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text ("Data from: "), bold font("Calibri Light", 10)
    putpdf text ("UN DESA, Population Division (2019). World Population Prospects (Ref. 16), and from WHO Global Health Estimates (2019). (Refs. 19-21)"), font("Calibri Light", 10)
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3b_men_lo", replace
...
** ----------------------------------------------------------
    ...
    ** Country names
    ...
    labmask y, val(cname)
    #delimit ; 
    label define y         21 "St.Vincent & Gren"
                            17 "Antigua & Barbuda"
                            30 "Trinidad & Tobago"
                            1  "Dominican Rep", modify;
    label values y y; 
...
** CHART
	...
	graph twoway 
		...
		name(daly_est_men_hi)
	;
#delimit cr
graph export "`outputpath'/figure3b_daly_men_hi.png", replace width(4000)
...
** FIGURE
    ...
    putpdf table t2 = (1,1), width(90%) halign(center) border(all,nil) 
    putpdf table t2(1,1)=image("`outputpath'/figure3b_daly_men_hi.png")
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text ("Data from: "), bold font("Calibri Light", 10)
    putpdf text ("UN DESA, Population Division (2019). World Population Prospects (Ref. 16), and from WHO Global Health Estimates (2019). (Refs. 19-21)"), font("Calibri Light", 10)
** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/figure3b_men_hi", replace
...
replace cname = "LAC" if cname ==""
	...
	** Begin Table 
	...
	putdocx paragraph 
		putdocx text ("TABLE S11. "), bold
		putdocx text ("Deaths in 2000 and in 2019, and percentage change in deaths between 2000 and 2019, with associated 95% Uncertainty Intervals. Men only."), 
		** Place data 
		...
		** Column and Row headers
		...
		putdocx save "`outputpath'/decomp_men_ci", replace 
