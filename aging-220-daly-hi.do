...
** save "`datapath'\from-who\paper1-chap3_byage_groups_malefemale_daly", replace
   rename daly daly_hi
   save "`datapath'\from-who\daly1_hi", replace
...
** save "`datapath'\from-who\paper1-chap2_000e_daly_region_groups", replace
   rename cases cases_hi 
   rename crate crate_hi 
   rename arate arate_hi
   drop aupp alow    
   save "`datapath'\from-who\dalyrate1_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_groups_both_daly", replace
   rename daly daly_hi
   save "`datapath'\from-who\daly2_hi", replace
...
** save "`datapath'\from-who\paper1-chap2_000e_daly_region_groups_both", replace
   ...
   rename arate arate_hi
   drop aupp alow    
   save "`datapath'\from-who\dalyrate2_hi", replace




** Join
use "`datapath'\from-who\dalyrate2_hi" , clear
append using "`datapath'\from-who\dalyrate1_hi"
...
save "`datapath'\from-who\dalyrate_12_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale_daly", replace
   rename daly daly_hi
   save "`datapath'\from-who\daly3_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_both_daly", replace
   rename daly daly_hi
   save "`datapath'\from-who\daly4_hi", replace
