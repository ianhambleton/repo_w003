...
** ------------------------------------------------
    use "`datapath'\from-who\deaths4_ci", clear

** append using "`datapath'\from-who\paper1-chap3_byage_groups_both"
	append using "`datapath'\from-who\deaths2_ci"
...
** ------------------------------------------------
    use "`datapath'\from-who\daly4_ci", clear

** append using "`datapath'\from-who\paper1-chap3_byage_groups_both"
	append using "`datapath'\from-who\daly2_ci"
	keep if who_region==. | who_region==2
	replace iso3c = "LAC" if who_region==2
	replace iso3n = 2000 if who_region==2
...
** Save the decomposition dataset, then will be used for sensitivity analyses
save "`datapath'\from-who\decomposition_daly", replace

use "`datapath'\from-who\decomposition_deaths", replace
append using "`datapath'\from-who\decomposition_daly"

** FINAL decomp dataset
save "`datapath'\from-who\decomposition", replace
