** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    phd-yll-country-age-stratified.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	27-Jun-2024
    //  algorithm task			    Preparing YLL: Countries of the Americas
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\phd-yll-country-age-stratified", replace
** HEADER ----------------------------------------------------- 
...
label var yll "Years of life lost"
...
drop ase iso3n 
label data "Crude and Adjusted YLL rates: age-stratified"
tempfile file_mf 
...
** Metadata
label data "Restricted GHE YLL dataset (2000-2019): created 27-Jun-2024"
...
** Save datasets
save "`datapath'\phd\phd_yll_country_v1", replace
export excel using "`datapath'\phd\phd_yll_country_v1", sheet(who-ghe-2019-v1) first(var) replace 
