** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-114-cvd-daly-country.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-114-cvd-daly-country", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_cvd_daly_003", replace
...
gen sex = 3
label data "Crude and Adjusted DALYs: PAHO sub-regions"
save "`datapath'\from-who\chap2_cvd_daly_003_both", replace
