...
** Mortality rate 
use "`datapath'\paper2-inj\paper2_chap2_000_mr", clear
...
save "`datapath'\paper2-inj\paper2_chap2_000_mr_adjusted", replace
tempfile t1
save `t1', replace

** DALY rate 
use "`datapath'\paper2-inj\paper2_chap2_000_daly", clear
** Update RATE for sex-specific cancers
replace arate = arate * 100000 
replace arate_new = arate_new * 100000 
gen arate_final = arate
...
save "`datapath'\paper2-inj\paper2_chap2_000_daly_adjusted", replace

** Join the two datasets
merge 1:1 year sex ghecause region using `t1' 
drop _merge
save "`datapath'\paper2-inj\paper2_chap2_000_adjusted", replace
