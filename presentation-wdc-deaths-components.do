...
gen y1 = 1 if iso3n==388
replace y1 = 2 if iso3n==52
replace y1 = 3 if iso3n==28
replace y1 = 4 if iso3n==44

local line2 1.5 0 2.5 0
local line1 0.5 0 2.5 0
...
#delimit ;
	graph twoway 
        ...
        text(2 -20 "Barbados", place(w) size(8) color("gs4") just(center) margin(l=2 r=2 t=4 b=2))
        text(1 -20 "Jamaica", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
		...
		/// Change percentage
        text(2 93 "32%", place(e) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(1 93 "27%", place(e) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(3 93 "61%", place(e) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(4 93 "79%", place(e) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))

		/// Percentage 1
        text(1.3 -1 "-7%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
		...
		/// Change percentage
        text(2 93 "32%", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(1 93 "27%", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(3 93 "61%", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(4 93 "79%", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))

		/// Percentage 2
        text(1.3 -1 "-7%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(1.3 35 "35%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
        ...
        text(1.3 -1 "-7%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(1.3 35 "35%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(1.3 44 "6%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
		...
		/// Percentage 4
        text(1.9 50 "32%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
        ...
        text(2 -20 "Barbados", place(w) size(8) color("gs4") just(center) margin(l=2 r=2 t=4 b=2))
        text(1 -20 "Jamaica", place(w) size(8) color("gs4") just(center) margin(l=2 r=2 t=4 b=2))
        text(3 -20 "Antigua & Barbuda", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
        text(4 -20 "Bahamas", place(w) size(8) color("gs16") just(center) margin(l=2 r=2 t=4 b=2))
		...
		/// Percentage 4
        text(0.9 40 "27%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(1.9 50 "32%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
        ...
        text(0.9 40 "27%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(1.9 50 "32%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(2.9 81 "61%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
...
#delimit ;
	graph twoway 
        ...
        text(1.9 50 "32%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(2.9 81 "61%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
        text(3.9 90 "79%", place(w) size(7) color("gs8") just(center) margin(l=2 r=2 t=4 b=2))
