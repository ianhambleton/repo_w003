...
save "`datapath'\from-who\chap2_000p_yll_region", replace
...
** 18 age groups
save "`datapath'\from-who\chap2_equiplot_yll_byage", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted ylls: WHO regions"
save "`datapath'\from-who\chap2_000p_yll_region_both", replace
