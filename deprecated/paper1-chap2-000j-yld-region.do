** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000j-yld-region.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000j-yld-region", replace
** HEADER -----------------------------------------------------
...
gen age18 = age21
** For yld standardization we use 17 groups instead of 18 
...
** ------------------------------------------
** Loading ylds datasets for WHO regions 
** ------------------------------------------
...
///             keep if sex==`y'
///             keep if ghecause==`z' 
///             dstdize yld pop age18, by(who_region) using(`who_std')
...
label data "Crude and Adjusted ylds: WHO regions"
save "`datapath'\from-who\chap2_000j_yld_region", replace
...
** 18 age groups
save "`datapath'\from-who\chap2_equiplot_yld_byage", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted ylds: WHO regions"
save "`datapath'\from-who\chap2_000j_yld_region_both", replace
