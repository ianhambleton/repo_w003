...
gen age18 = age21
** For yld standardization we use 16 groups instead of 18 
** We do this because Guyana estimates. yld > Population when age 85+ 
...
collapse (sum) yld pop, by(year ghecause iso3n iso3c paho_subregion sex age18 agroup)
...
** Temporary Removal of "Natural Disaster" yld values for Haiti in 2010
preserve
    keep if iso3n==332 & year==2010 & ghecause==54
    save "`datapath'\from-who\chap2_000m_yld_country_haiti_natural_disaster_groups", replace
restore
...
///         rename yld yldt
///         gen yld = round(yldt*1000000) 
///         label var yld "ylds rounded to nearest integer" 
...
///             dstdize yld pop age18, by(iso3n) using(`who_std')
...
drop ase iso3n
order year ghecause region 
** drop aupp alow ase 
** replace pop = pop/1000000
label data "Crude and Adjusted ylds: PAHO sub-regions"
save "`datapath'\from-who\chap2_000m_yld_country_groups", replace
...
preserve
    keep if iso3n==332 & year==2010 & ghecause==54
    save "`datapath'\from-who\chap2_000m_yld_country_haiti_natural_disaster", replace
restore
...
/// ** replace pop = pop/1000000
/// label data "Crude and Adjusted ylds: PAHO sub-regions"
/// save "`datapath'\from-who\chap2_000m_yld_country_groups_both", replace
