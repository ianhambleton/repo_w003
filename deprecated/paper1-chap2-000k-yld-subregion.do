...
save "`datapath'\from-who\chap2_000k_yld_subregion", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted yld rates: PAHO sub-regions"
save "`datapath'\from-who\chap2_000k_yld_subregion_both", replace
