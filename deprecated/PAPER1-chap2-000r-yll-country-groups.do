...
gen age18 = age21
** For yll standardization we use 16 groups instead of 18 
...
collapse (sum) yll pop, by(year ghecause iso3n iso3c paho_subregion sex age18 agroup)
...
** Temporary Removal of "Natural Disaster" yll values for Haiti in 2010
preserve
    keep if iso3n==332 & year==2010 & ghecause==54
    save "`datapath'\from-who\chap2_000r_yll_country_haiti_natural_disaster_groups", replace
restore
...
///             dstdize yll pop age18, by(iso3n) using(`who_std')
...
label data "Crude and Adjusted ylls: PAHO sub-regions"
save "`datapath'\from-who\chap2_000r_yll_country_groups", replace
...
preserve
    keep if iso3n==332 & year==2010 & ghecause==54
    save "`datapath'\from-who\chap2_000r_yll_country_haiti_natural_disaster", replace
restore
...
/// ** replace pop = pop/1000000
/// label data "Crude and Adjusted ylls: PAHO sub-regions"
/// save "`datapath'\from-who\chap2_000r_yll_country_groups_both", replace
