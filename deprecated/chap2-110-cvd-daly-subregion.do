** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-110-cvd-daly-subregion.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-110-cvd-daly-subregion", replace
** HEADER -----------------------------------------------------
...
** ------------------------------------------
** Loading daly dataset for the Americas only 
** Americas (AMR)
**  1100    Cardiovascular 
...
keep if ghecause==1100 | ghecause==1110 | ghecause==1120 | ghecause==1130 | ghecause==1140 | ghecause==1150 | ghecause==1160
    ...
    ** Collapse from countries to subregions
    collapse (sum) daly pop, by(ghecause year paho_subregion sex age)
...
label var daly "DALY rounded to nearest integer" 
...
save "`datapath'\from-who\chap2_cvd_daly_001", replace
...
gen sex = 3 
label data "Crude and Adjusted DALY rates: PAHO sub-regions"
save "`datapath'\from-who\chap2_cvd_daly_001_both", replace
