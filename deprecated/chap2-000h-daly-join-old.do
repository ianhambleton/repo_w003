** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000h-daly-join.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000h-daly-join", replace
** HEADER -----------------------------------------------------
...
append using "`datapath'\from-who\chap2_000e_daly_region_both"
append using "`datapath'\from-who\chap2_000f_daly_subregion_both"
append using "`datapath'\from-who\chap2_000g_daly_country_both"
