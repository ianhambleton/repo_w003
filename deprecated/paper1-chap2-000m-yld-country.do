...
replace yld = 0 if iso3n==332 & year==2010 & ghecause==54
...
save "`datapath'\from-who\chap2_000m_yld_country", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted ylds: PAHO sub-regions"
save "`datapath'\from-who\chap2_000m_yld_country_both", replace
