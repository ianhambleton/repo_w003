** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000d-deaths-SEAR.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	26-Apr-2021
    //  algorithm task			    Preparing CVD mortality rates: SOUTH-EAST ASIA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000d-deaths-SEAR", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_000d_dths_SEAR", replace
...
gen sex = 3 
label data "DEATHS : Countries, WHO regions"
save "`datapath'\from-who\chap2_000d_dths_both_SEAR", replace
