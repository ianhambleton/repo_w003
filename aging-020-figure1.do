...
twoway 
     ...
     /// (7) Brazil
     /// (8) Mexico   
     (scatter y1 x1 if paho_subregion==1 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==1 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))    
     (scatter y1 x1 if paho_subregion==2 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==2 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==3 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==3 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==3 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==4 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==4 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==4 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==5 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==5 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==5 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==6 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==6 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==6 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==7 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==7 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==7 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==8 & year==1980 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==1980 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==1980 & agroup==3, msize(0.15) mc("`gre'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==2020 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==2020 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==2020 & agroup==3, msize(0.15) mc("`gre'") m(O))  
     (scatter y1 x1 if paho_subregion==8 & year==2060 & agroup==1, msize(0.15) mc("`bl2'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==2060 & agroup==2, msize(0.15) mc("`ora'") m(O))
     (scatter y1 x1 if paho_subregion==8 & year==2060 & agroup==3, msize(0.15) mc("`gre'") m(O))  

    /// Legend 
     (scatteri `a1' , recast(area) lw(none) lc("`bl2'") fc("`bl2'")  )
     (scatteri `a2' , recast(area) lw(none) lc("`ora'") fc("`ora'")  )
     (scatteri `a3' , recast(area) lw(none) lc("`gre'") fc("`gre'")  )
	...
	yscale(noline lw(none) lc(gs16) noextend range(-25(10)215)) 
...
** Save the PDF
    ...
    putpdf save "`outputpath'/figure1", replace
