...
use `create_table', clear
        ...
        ** Save Word table
        putdocx save "`outputpath'/articles/paper-ncd/article-draft/supplement-ncd-table-men", replace 
...
use `create_table', clear
        ...
        ** Save Word table
        putdocx save "`outputpath'/articles/paper-ncd/article-draft/supplement-ncd-table-women", replace 
