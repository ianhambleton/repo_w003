...
*! Add loop over YEAR (19), SEX (2), GHECAUSE (3)
...
forval x = 2000(1)2019 {
    ...
    matrix m`x' = r(crude) \ r(adj) \r(ub_adj) \ r(lb_adj) \  r(se) \ r(Nobs)
    matrix m`x' = m`x''
    svmat double m`x', name(col)
