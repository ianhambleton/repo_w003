** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    phd-mr-country-age-standardized.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	11-Jun-2024
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\phd-mr-country-age-standardized", replace
** HEADER ----------------------------------------------------- 
...
save "`datapath'\phd\phd_mr_country", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted mortality rates: PAHO sub-regions"
save "`datapath'\phd\phd_mr_country_both", replace
...
label values sex sex_ 
order region sex year ghecause  
sort region sex year ghecause 
...
** Metadata
label data "Restricted GHE dataset (2000-2019): created 11-Jun-2024"
label data "Created by Ian Hambleton (11-Jun-2024)"
...
** Save datasets
save "`datapath'\phd\phd_mr_country_v1", replace
export excel using "`datapath'\phd\phd_mr_country_v1", sheet(who-ghe-2019-v1) first(var) replace 
