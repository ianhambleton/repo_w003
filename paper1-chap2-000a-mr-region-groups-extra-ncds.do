...
* TODO: Change restriction for each disease group
   ...
   #delimit ;
    keep if     
                ...
                ghecause==0     |
                ghecause==10    |           /// Comm, Maternal, Perinatal, Nutritional
                ghecause==600   |           /// All NCDs
                ghecause==610   |           /// Cancers
                ghecause==800   |           /// Diabetes
                ghecause==810   |           /// Endocrine, blood, immune 
                ghecause==820   |           /// mental and substance use
                ghecause==940   |           /// Neurological
                ghecause==1100  |           /// Cardiovascular
                ghecause==1210  |           /// Digestive
                ghecause==1260  |           /// Genitourinary
                ghecause==1330  |           /// Skin
                ghecause==1340  |           /// Musculoskeletal
                ghecause==1170  |           /// Respiratory
                ghecause==1510              /// Injuries
                ;
    #delimit cr

** Report and Paper definition: count of deaths by year

** Recode for mortality rate loop
    #delimit ; 
    recode ghecause 
                    (0 = 100 )          /// All cause
                    (10 = 200 )         /// Comm, Maternal, Perinatal, Nutritional
                    (600 = 300 )        /// All NCDs
                    (1100 = 400 )       /// Cardiovascular
                    (610  = 500 )       /// Cancers
                    (1170 = 600 )       /// Respiratory
                    (800  = 700 )       /// Diabetes
                    (820 = 800 )        /// mental and substance use
                    (940 = 900 )        /// Neurological
                    (1510 = 1000 )      /// Injuries
                    (810 = 2000)        /// Endocrine, blood, immune 
                    (1210 = 3000)       /// Digestive
                    (1260 = 4000)       /// Genitourinary
                    (1330 = 5000)       /// Skin
                    (1340 = 6000)       /// Musculoskeletal
                    ;
    #delimit cr
    drop if age<0 
...
** Collapse out age
collapse (sum) dths pop, by(year ghecause who_region)
keep if year==2019
...
save "`datapath'\from-who\paper1-chap2_000_mr", replace
