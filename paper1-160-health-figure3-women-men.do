...
use "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale", clear
append using "`datapath'\from-who\paper1-chap3_byage_groups_malefemale"
	keep if sex==2
...
use "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale_daly", clear
append using "`datapath'\from-who\paper1-chap3_byage_groups_malefemale_daly"
	keep if sex==2 
	keep if who_region==. | who_region==2
	replace iso3c = "LAC" if who_region==2
	replace iso3n = 2000 if who_region==2
