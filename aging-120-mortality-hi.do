...
** save "`datapath'\from-who\paper1-chap3_byage_groups_malefemale", replace
   rename dths dths_hi
   save "`datapath'\from-who\deaths1_hi", replace
...
** save "`datapath'\from-who\paper1-chap2_000a_mr_region-groups", replace
   ...
   drop aupp alow 
   save "`datapath'\from-who\mortalityrate1_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_groups_both", replace
   rename dths dths_hi
   save "`datapath'\from-who\deaths2_hi", replace
...
** save "`datapath'\from-who\paper1-chap2_000a_mr_region_groups_both", replace
   ...
   rename arate arate_hi
   drop aupp alow 
   save "`datapath'\from-who\mortalityrate2_hi", replace
...
use "`datapath'\from-who\mortalityrate2_hi" , clear
append using "`datapath'\from-who\mortalityrate1_hi"
...
save "`datapath'\from-who\mortalityrate_12_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_malefemale", replace
   rename dths dths_hi
   save "`datapath'\from-who\deaths3_hi", replace
...
** save "`datapath'\from-who\paper1-chap3_byage_country_groups_both", replace
   rename dths dths_hi
   save "`datapath'\from-who\deaths4_hi", replace
