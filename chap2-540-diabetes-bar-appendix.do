...
#delimit ;  
	gr twoway 
        ...
        (sc value1 x1, msymbol(i) mlabel(value1) mlabsize(6) mlabcol(gs8) mlabp(0))
                		,
...
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-B.svg", replace
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-B.pdf", replace
...
#delimit cr	
** Export to Vector Graphic
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-A.svg", replace
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-A.pdf", replace
...
#delimit ;  
	gr twoway 
        ...
        (rbar origin1 scaler1 region1 if cod==1 & region==2000, horizontal barw(0.6) fcol(gs0) lcol(gs0) lw(0.1))           
        (sc value1 x1, msymbol(i) mlabel(ad6s) mlabsize(6) mlabcol(gs8) mlabp(0))
                		,
			plotregion(c(gs16) ic(gs16) ilw(thin) lw(thin)) 		
			graphregion(color(gs16) ic(gs16) ilw(thin) lw(thin)) 
			ysize(16) xsize(4)
...
#delimit cr	
** Export to Vector Graphic
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-C.svg", replace
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-C.pdf", replace
...
#delimit cr	
** Export to Vector Graphic
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-D.svg", replace
graph export "`outputpath'\reports\2024-edits\graphics\figA4-4-D.pdf", replace
