** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2026-figure3.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2026-figure3", replace
** HEADER -----------------------------------------------------
...
#delimit ;  
	gr twoway 
        ...
        (rbar origin2021_up drat2021 yorder2021 if cod==1 & region!=44 , horizontal barw(0.5) fcol("`a1'") lcol("gs0") lw(0.1))   
        (rbar origin2021_up drat2021 yorder2021 if cod==2 & region!=44 , horizontal barw(0.5) fcol("`a2'") lcol("gs0") lw(0.1))   
        (rbar origin2021_up drat2021 yorder2021 if cod==3 & region!=44 , horizontal barw(0.5) fcol("`a8'") lcol("gs0") lw(0.1))   
        (rbar origin2021_up drat2021 yorder2021 if cod==4 & region!=44 , horizontal barw(0.5) fcol("`a4'") lcol("gs0") lw(0.1))   
        (rbar origin2021_up drat2021 yorder2021 if cod==5 & region!=44 , horizontal barw(0.5) fcol("`a5'") lcol("gs0") lw(0.1))   
        ...
        (sc yorder2021 xlocation, msymbol(i) mlabel(i2021) mlabsize(2.5) mlabcol(gs0) mlabp(0))
                		,
			...
			labc(gs5) labs(2.2) tstyle(major_notick) nogrid glc(gs16) angle(0) format(%9.0f) labgap(1))
			yscale(reverse noline lw(vthin) range(-2(1)38)) 
			ytitle("", size(2) margin(l=0 r=0 t=0 b=0)) 

            text(-0.8 -0.2 "Gender" "Ratio"  , place(c) size(2.5) color("gs0") just(center) )
            ...
            text(21 9.9 "Self harm"                 , place(w) size(3) color("`a8'") just(right) )
