** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    p004-load-ghe-hale-country.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\p004-load-ghe-hale-country", replace
** HEADER -----------------------------------------------------
...
** ************************************************************
insheet using "`datapath'\from-who\lifetables\hale-2019-country.csv", clear comma names
...
* Keep just the Americas 
keep if region=="AMR" 

** Country 
rename countrycode country 
drop countrydisplay countryurl 
label var country "Country ISO3 code"
...
** HALE dataset
label data "WHO GHE 2019: HALE countries"
save "`datapath'\from-who\lifetables\who-hale-2019-country", replace
