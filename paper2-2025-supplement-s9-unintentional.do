** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2025-supplement-s9-unintentional.do
    //  project:				    UN WPP (2019 edition)
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	24-Mar-2022
    //  algorithm task			    Supplement - Road Injuries
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2025-supplement-s9-unintentional", replace
** HEADER -----------------------------------------------------
...
** KEEP Unintentional (was 1100, now 5)
keep if ghecause==5
...
** ------------------------------------------------------
    ...
    ** COLS 11/13. Change 2000-2021 (DALY rate)
        ...
        ** Save Word table
        putdocx save "`outputpath'/inj_table_s9-unintentional", replace 
