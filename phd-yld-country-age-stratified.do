** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    phd-yld-country-age-stratified.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	27-Jun-2024
    //  algorithm task			    Preparing YLD: Countries of the Americas
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\phd-yld-country-age-stratified", replace
** HEADER ----------------------------------------------------- 
...
label var year "Year of yld rate"
...
drop ase iso3n 
label data "Crude and Adjusted yld rates: age-stratified"
tempfile file_mf 
...
label data "Crude and Adjusted yld rates"
tempfile file_both 
...
** Metadata
label data "Restricted GHE YLD dataset (2000-2019): created 27-Jun-2024"
...
** Save datasets
save "`datapath'\phd\phd_yld_country_v1", replace
export excel using "`datapath'\phd\phd_yld_country_v1", sheet(who-ghe-2019-v1) first(var) replace 
