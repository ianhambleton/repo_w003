** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-20256-003b-yldrate.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2026-003b-yldrate", replace
** HEADER -----------------------------------------------------
...
** Loading INJURY YLDs
** ------------------------------------------
use "`datapath'\ghe-2021-yld-001", replace
...
save "`datapath'\ghe-2021-yld-byage", replace
...
label var ghecause "Broad causes of YLDs"
...
label data "Crude and Adjusted YLD rates: Countries, PAHO sub-regions, region"
save "`datapath'\ghe-2021-yld-rate-001", replace
