** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000d-daly-EMR.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000d-daly-EMR", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_000h_daly_EMR", replace

** Save the final DALY dataset - collapsed over SEX
collapse (sum) daly pop , by(who_region region year ghecause) 
gen sex = 3 
label data "DALYs : Countries, WHO regions"
save "`datapath'\from-who\chap2_000h_daly_both_EMR", replace
