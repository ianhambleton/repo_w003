** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2026-003a-yllrate.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2026-003a-yllrate", replace
** HEADER -----------------------------------------------------
...
** Loading INJURY YLLs
** ------------------------------------------
use "`datapath'\ghe-2021-yll-001", replace
...
save "`datapath'\ghe-2021-yll-byage", replace
...
label var ghecause "Broad causes of YLLs"
...
label data "Crude and Adjusted YLL rates: Countries, PAHO sub-regions, region"
save "`datapath'\ghe-2021-yll-rate-001", replace
