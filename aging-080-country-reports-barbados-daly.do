...
** forval a = 1(1)33 {
        ...
        use "X:\OneDrive - The University of the West Indies\Writing\w003\data\from-who\chap2_000_daly_adjusted", clear
...
** forval a = 1(1)33 {
    ...
    use "`outputpath'/country_report_table4-daly", clear
...
** Save the PDF
    ...
    putpdf save "`outputpath'/briefing-`crep'-dalys", replace
