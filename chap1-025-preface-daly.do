...
** Africa (AFR)
use "`datapath'\from-who\who-ghe-daly-001-who1", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
...
** Americas (AMR)
use "`datapath'\from-who\who-ghe-daly-001-who2", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
    keep if ghecause==10 | ghecause==600 | ghecause==1510
...
use "`datapath'\from-who\who-ghe-daly-001-who3", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
    keep if ghecause==10 | ghecause==600 | ghecause==1510
...
** Europe (EUR)
use "`datapath'\from-who\who-ghe-daly-001-who4", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
    keep if ghecause==10 | ghecause==600 | ghecause==1510
...
use "`datapath'\from-who\who-ghe-daly-001-who5", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
    keep if ghecause==10 | ghecause==600 | ghecause==1510
...
** Western Pacific (WPR)
use "`datapath'\from-who\who-ghe-daly-001-who6", replace
    rename daly dths
    rename daly_low dths_low 
    rename daly_up dths_up 
    keep if ghecause==10 | ghecause==600 | ghecause==1510
...
use `afr', clear 
    ...
    append using `sear'
    append using `wpr'
    save "`datapath'\from-who\chap1_daly_001", replace
