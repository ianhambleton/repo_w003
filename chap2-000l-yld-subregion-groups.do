...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000f-daly-subregion", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_000f_yld_subregion_groups", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted yld rates: PAHO sub-regions"
save "`datapath'\from-who\chap2_000f_yld_subregion_groups_both", replace
