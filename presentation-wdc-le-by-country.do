...
#delimit ;
	gr twoway 
		...
		/// HAITI (line metric year if locationid==332 & sexid==3 , lw(0.25) col6r("`oth'%40"))
		/// N=5 --> ABOVE Americas LE in 2019
		(line metric year  if locationid==28 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year  if locationid==44 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year  if locationid==84 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year  if locationid==92 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==192 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==212 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==214 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==254 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==308 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==328 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==388 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==500 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==531 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==533 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==534 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==535 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==659 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==660 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==662 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==666 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==670 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==740 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==780 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==796 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==850 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==663 & sexid==3 , lw(0.35) color(gs16))
		(line metric year if locationid==136 & sexid==3 , lw(0.35) color(gs16))
		(line metric year  if locationid==60 & sexid==3 , lw(0.35) color(gs16))
		(line metric year if locationid==312 & sexid==3 , lw(0.35) color(gs16))
...
#delimit ;
	gr twoway 
		...
		(line metric year if locationid==796 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==850 & sexid==3 , lw(0.35) color("`oth'%70"))
		(line metric year if locationid==663 & sexid==3 , lw(0.35) color("`amr'%70"))
		(line metric year if locationid==136 & sexid==3 , lw(0.35) color("`amr'%70"))
		(line metric year  if locationid==60 & sexid==3 , lw(0.35) color("`amr'%70"))
		(line metric year if locationid==312 & sexid==3 , lw(0.35) color("`amr'%70"))
		(line metric year if locationid==652 & sexid==3 , lw(0.35) color("`amr'%70"))
