...
#delimit ;
	gr twoway 
        ...
        (rbar origin6 scaler6 region6 if cod==6 & region==2000, horizontal barw(0.6) fcol(gs0) lcol(gs0) lw(0.1))           
           ...
           /// Region Titles 
           text(56 50  "Interpersonal" "Violence"         ,  place(c) size(3) color(gs8) just(center))
           text(56 170 "Road" "Injury"                           ,  place(c) size(3) color(gs8) just(center))
           text(56 290 "Self" "Harm"    ,  place(c) size(3) color(gs8) just(center))
           text(56 410 "Falls"             ,  place(c) size(3) color(gs8) just(center))
           text(56 530 "Mechanical" "Forces"        ,  place(c) size(3) color(gs8) just(center))
           text(56 650 "All" "Injury"                        ,  place(c) size(3) color(gs8) just(center))
           ...
           text(10.6 567                      ,  place(c) size(4) color("`child'*0.5") just(center))
           ...
           /// NOTE
           text(-21.5 0.5 "`ddagger' BLACK BAR is the mortality rate for the Region of the Americas." ,  
