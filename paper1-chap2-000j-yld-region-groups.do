...
** List for TABLE 1.3
preserve
    use "`datapath'\from-who\chap2_000j_yld_region-groups", clear
...
** Join
use "`datapath'\from-who\chap2_000j_yld_region_groups_both" , clear
append using "`datapath'\from-who\chap2_000j_yld_region_groups"
