...
save "`datapath'\from-who\chap2_000e_yld_region_groups", replace
...
** 18 age groups
save "`datapath'\from-who\chap2_equiplot_yld_byage_allcvd", replace
save "`datapath'\from-who\chap2_equiplot_yld_byage_groupeddeath", replace
...
** replace pop = pop/1000000
label data "Crude and Adjusted ylds: WHO regions"
save "`datapath'\from-who\chap2_000e_yld_region_groups_both", replace
