...
use `afr', clear 
    ...
    append using `sear'
    append using `wpr'
collapse (sum) dths pop , by(year age sex ghecause)
gen who_region = 1
format dths pop %15.2fc
...
* Regions
recode region 1=10000
#delimit ; 
label define region_    10000 "global", modify; 
#delimit cr 
