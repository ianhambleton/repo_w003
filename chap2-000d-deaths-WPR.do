** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000d-deaths-WPR.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	26-Apr-2021
    //  algorithm task			    Preparing CVD mortality rates: WESTERN PACIFIC
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000d-deaths-WPR", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_000d_dths_WPR", replace
...
gen sex = 3 
label data "DEATHS : Countries, WHO regions"
save "`datapath'\from-who\chap2_000d_dths_both_WPR", replace
