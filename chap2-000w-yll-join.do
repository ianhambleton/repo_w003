...
use "`datapath'\from-who\chap2_000e_yll_region", clear
...
** SUBREGION
** Female cancers -> bring in the female rates
use "`datapath'\from-who\chap2_000f_yll_subregion", clear
    keep if sex==2 & (ghecause>=14 & ghecause<=17) 
    rename arate arate_new
    rename pop pop_new 
    keep arate_new pop_new year ghecause region
...
** COUNTRY
** Female cancers -> bring in the female rates
use "`datapath'\from-who\chap2_000g_yll_country", clear
    keep if sex==2 & (ghecause>=14 & ghecause<=17) 
    rename arate arate_new
    rename pop pop_new 
    keep arate_new pop_new year ghecause region
...
use "`datapath'\from-who\chap2_000e_yll_region_both" , clear
merge 1:1 year ghecause region using `region_f'
drop _merge
merge 1:1 year ghecause region using `region_m' , update replace
drop _merge
save "`datapath'\from-who\chap2_000e_yll_region_both_updated" , replace

** SUBREGION
** Replace selected cancers with sex-specific rates
use "`datapath'\from-who\chap2_000f_yll_subregion_both" , clear
merge 1:1 year ghecause region using `subregion_f'
drop _merge
merge 1:1 year ghecause region using `subregion_m' , update replace
drop _merge
save "`datapath'\from-who\chap2_000f_yll_subregion_both_updated" , replace

** COUNTRY
** Replace selected cancers with sex-specific rates
use "`datapath'\from-who\chap2_000g_yll_country_both" , clear
merge 1:1 year ghecause region using `country_f'
drop _merge
merge 1:1 year ghecause region using `country_m' , update replace
drop _merge
save "`datapath'\from-who\chap2_000g_yll_country_both_updated" , replace
...
use          "`datapath'\from-who\chap2_000e_yll_region", clear
append using "`datapath'\from-who\chap2_000f_yll_subregion"
append using "`datapath'\from-who\chap2_000g_yll_country"
append using "`datapath'\from-who\chap2_000e_yll_region_both_updated"
append using "`datapath'\from-who\chap2_000f_yll_subregion_both_updated"
append using "`datapath'\from-who\chap2_000g_yll_country_both_updated"
** Append the grouped information
append using "`datapath'\from-who\chap2_000e_yll_region_groups_both"
append using "`datapath'\from-who\chap2_000e_yll_region_groups"
append using "`datapath'\from-who\chap2_000f_yll_subregion_groups_both"
append using "`datapath'\from-who\chap2_000f_yll_subregion_groups"
append using "`datapath'\from-who\chap2_000g_yll_country_groups_both"
append using "`datapath'\from-who\chap2_000g_yll_country_groups"
...
/// ** Merge the yll dataset with the yll rate dataset (mr1)
/// tempfile d1 
/// use "`datapath'\from-who\chap2_000h_yll", clear
/// append using "`datapath'\from-who\chap2_000h_yll_both"
/// rename pop pop_yll 
/// label define sex_ 1 "men" 2 "women" 3 "both" , modify
/// label values sex sex_ 
/// keep year ghecause sex region paho_subregion yll pop_yll
/// sort year sex ghecause region 
/// merge 1:1 year sex ghecause region using `mr1' 
/// 
/// rename _merge yll_exist
/// recode yll_exist 3=1 2=0 1=10
/// label define yll_exist_ 1 "yes" 0 "no" 10 "temp code"
/// label values yll_exist yll_exist_
...
save "`datapath'\from-who\chap2_000_yll", replace
