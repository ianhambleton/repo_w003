** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-116-cvd-daly-join.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-116-cvd-daly-join", replace
** HEADER -----------------------------------------------------
...
append using "`datapath'\from-who\chap2_cvd_daly_002"
append using "`datapath'\from-who\chap2_cvd_daly_001"
append using "`datapath'\from-who\chap2_cvd_daly_001_both"
append using "`datapath'\from-who\chap2_cvd_daly_002_both"
append using "`datapath'\from-who\chap2_cvd_daly_003_both"
...
label data "Crude and Adjusted DALYs: Countries, PAHO sub-regions, WHO regions"
