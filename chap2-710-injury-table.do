...
restore
    ...
    ** Export data for TABLE-9
    ...
    sort disease year  
    export excel "`outputpath'\reports\2024-edits\graphics\chap2_data.xlsx", sheet("table-9-deaths", replace) first(var) keepcellfmt   
...
restore
    ...
    ** Export data for TABLE-9
    ...
    sort disease year  
    export excel "`outputpath'\reports\2024-edits\graphics\chap2_data.xlsx", sheet("table-9-daly", replace) first(var) keepcellfmt   
