...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\presentation-wdr-mr-nonlatin-caribbean-change", replace
** HEADER -----------------------------------------------------
...
** Temporary name change - 14Mar2025
rename mortr arate
rename dalyr drate
...
** Output: Total Deaths
preserve 
    keep if region==600 & year==2019 & sex==3
    sort cod 
...
preserve
    keep if region==600 & year==2000 & sex==3
    sort cod 
...
preserve
    keep if sex==3 & region==600 & (year==2000 | year==2019)
    keep  year cod arate 
...
preserve
    keep if sex<3 & region==600 & year==2019
    keep sex cod arate 
