** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    chap2-000d-deaths-AFR.do
    //  project:				    WHO Global Health Estimates
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	    	26-Apr-2021
    //  algorithm task			    Preparing CVD mortality rates: AFRICA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\chap2-000d-deaths-AFR", replace
** HEADER -----------------------------------------------------
...
save "`datapath'\from-who\chap2_000d_dths_AFR", replace

** Save the final MR dataset - collapsed over SEX
collapse (sum) dths pop , by(who_region region year ghecause) 
gen sex = 3 
label data "DEATHS : Countries, WHO regions"
save "`datapath'\from-who\chap2_000d_dths_both_AFR", replace
