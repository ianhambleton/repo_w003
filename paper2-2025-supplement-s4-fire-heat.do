** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper2-2025-supplement-s4-fire-heat.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper2-2025-supplement-s4-fire-heat", replace
** HEADER -----------------------------------------------------
...
** KEEP Fire and Heat (was 51, now 10)
keep if ghecause==10
...
** ------------------------------------------------------
    ...
    ** COLS 11/13. Change 2000-2021 (DALY rate)
        ...
        ** Save Word table
        putdocx save "`outputpath'/inj_table_s4-fire-heat", replace 
