** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    paper1-countryreport2.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper1-countryreport2", replace
** HEADER -----------------------------------------------------
...
** forval a = 1(1)33 {
        ...
        **use "X:\OneDrive - The University of the West Indies\Writing\w003\data\from-who\mortalityrate_12", clear
...
** forval a = 1(1)33 {
    ...
    use "`outputpath'/country_report_table4-mortality", clear
...
** TITLE, ATTRIBUTION, DATE of CREATION
    ...
    putpdf table intro(1,2)=("Population Aging and Noncommunicable Disease in $cname. (PART 1) DEATHS"), halign(left) linebreak font("Calibri Light", 12, 000000)
...
** INTRODUCTION
    ...
    putpdf text ("THE ELDERLY "), bold font("Calibri Light", 12)
    putpdf text ("population in Barbados (70+) has been growing fast, and this will continue. "), font("Calibri Light", 11)
    putpdf text ("Compared to 2000, in 2020 there were almost 5,000 more elderly women and another 5,000 more elderly men living on the island."), font("Calibri Light", 11)
...
** TABLE: KEY SUMMARY METRICS
    ...
    ** FIGURE 1. 70+ percentages for COUNTRY, Sub-Region, Americas
    ...
    putpdf text ("BETWEEN 2000 and 2060 "), bold font("Calibri Light", 12)
    putpdf text ("the number of elderly men is expected to triple, and the number of elderly women more than double. "), font("Calibri Light", 11)
    putpdf text ("By 2060 almost a quarter of all Barbadians will be 70 years and older."), font("Calibri Light", 11)
...
** TABLE 3
    putpdf paragraph ,  font("Calibri Light", 10)
    putpdf text (" "), linebreak
    putpdf text ("SINCE 2000 ") , bold font("Calibri Light", 12)
    putpdf text ("the Barbados health system has presided over a reduction in death rates due to NCDs. "), font("Calibri Light", 11)
    putpdf text ("Rates have dropped for both women and men."), font("Calibri Light", 11)
...
** Save the PDF
    ...
    putpdf save "`outputpath'/briefing-`crep'-deaths", replace
