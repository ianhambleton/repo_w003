...
** 27 MARCH 2024
** GRAPHIC CHANGE TO ALLOW SPAFE SEPARATION IN 1000's
...
** New variable with space separator for 1000s
gen ad1 = ad/1000
gen ad2 = ad1 - int(ad1)
gen ad3 = int(ad1)
gen ad4 = ad2 * 1000
...
#delimit ;
	graph twoway 
		...
		(sc y1 xloc3, msymbol(i) mlabel(ad6s) mlabsize(2.5) mlabcol(gs8) mlabp(9) )
        ...
        text(-10.5 -60 "`dagger' Saint Vincent = Saint Vincent and the Grenadines." ,  
